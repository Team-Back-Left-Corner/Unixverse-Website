		...
		<div class="chapters">
			<div class="chapter-column">
				<div class="chapter">
					...
					<ul>
						<li><a href="#">Section 1 Files and system basics</a></li>
						<li><a href="#">Section 2 Directory structure / Navigation</a></li>
					</ul>
					<div style="display:flex;margin-left:20px;">
						<input type="submit" value="Section Quiz"/>
						<h4 style="margin-left:20px;">Current Score: 0%</h4>
					</div>
				</div>
				<div class="chapter">
					...
					<ul>
						<li><a href="#">Section 1 Access modes</a></li>
						<li><a href="#">Section 2 Linux file ownership</a></li>
						<li><a href="#">Section 3 CHMOD</a></li>
					</ul>
					<div style="display:flex;margin-left:20px;">
						<a href="pages/quiz/section_one_quiz.php"/>Section Quiz</a>
						<h4 style="margin-left:20px;">Current Score: 0%</h4>
					</div>
				</div>
				<div class="chapter">
					...
					<ul>
						<li><a href="#">Section 1 SSH</a></li>
						<li><a href="#">Section 2 FTP and SFTP</a></li>
						<li><a href="#">Section 3 Filezilla</a></li>
					</ul>
					<div style="display:flex;margin-left:20px;">
						<input type="submit" value="Section Quiz"/>
						<h4 style="margin-left:20px;">Current Score: 0%</h4>
			...
			<div class="chapter">
					...
					<ul>
						<li><a href="#">Section 1 Nano</a></li>
						<li><a href="#">Section 2 Vim</a></li>
						<li><a href="#">Section 3 Emacs</a></li>
					</ul>
					<div style="display:flex;margin-left:20px;">
						<input type="submit" value="Section Quiz"/>
						<h4 style="margin-left:20px;">Current Score: 0%</h4>
				...
				<div class="chapter">
					...
					<ul>
						<li><a href="#">Section 1 ifconfig, ping</a></li>
						<li><a href="#">Section 2 arp + traceroute</a></li>
					</ul>
					<div style="display:flex;margin-left:20px;">
						<input type="submit" value="Section Quiz"/>
						<h4 style="margin-left:20px;">Current Score: 0%</h4>
